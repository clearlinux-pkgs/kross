...
Source0  : https://download.kde.org/stable/frameworks/5.89/portingAids/kross-5.89.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.89/portingAids/kross-5.89.0.tar.xz.sig
...
%prep
%setup -q -n kross-5.89.0
cd %{_builddir}/kross-5.89.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639700133
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kross-5.89.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kross/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kross5
...
/usr/lib64/libKF5KrossCore.so.5.89.0
/usr/lib64/libKF5KrossUi.so.5
/usr/lib64/libKF5KrossUi.so.5.89.0
